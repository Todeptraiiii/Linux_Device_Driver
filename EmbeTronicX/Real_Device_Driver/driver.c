...
#define mem_size 1024 // memnory size
...
static int __init etx_driver_init(void)
{
    ...
    // tao bo nho trong  kernel space
    if((kernel_buffer = kmalloc(mem_size, GFP_KERNEL)) == 0)
    {
        pr_info("Khong the phan bo bo nho trong kernel space \n");
        goto r_device;
    }
...
static void __exit etx_driver_exit(void)
{
    // giai phong bo nho da tao trong kernel space
    kfree(kernel_buffer);
