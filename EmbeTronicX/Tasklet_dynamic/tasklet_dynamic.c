...
/* tao tasklet dynamic method */
struct tasklet_struct *tasklet = NULL;

void tasklet_fn(unsigned long arg)
{
    printk(KERN_INFO "Thuc thi tasklet function: arg = %ld \n",arg);
}
...
static int __init etx_driver_init(void)
{
        ...
        /* Khoi tao tasklet bang pp Dynamic Method */
        tasklet  = kmalloc(sizeof(struct tasklet_struct),GFP_KERNEL);
        if(tasklet == NULL) 
        {
            printk(KERN_INFO "etx_device: cnnot allocate Memory");
            goto irq;
        }
